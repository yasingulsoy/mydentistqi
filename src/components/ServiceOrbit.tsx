...
import { ArrowRightIcon, serviceIcons as iconMap } from "./icons";
import { serviceIcons, type Dict } from "@/data/content";
...
export function ServiceOrbit({ dict }: { dict: Dict }) {
        ...
        <div className="mt-14 flex justify-center lg:mt-0">
          <div className="relative aspect-square w-full max-w-[630px]">
            ...
            {t.labels.map((label, i) => {
              ...
              return (
                <div key={label} className="absolute -translate-x-1/2 -translate-y-1/2" style={pos}>
