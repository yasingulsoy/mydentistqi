  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6">
        <label className="sr-only" htmlFor="ad-soyad">
          Ad Soyad
        </label>
        <input
          id="ad-soyad"
        ...
        <div className="flex h-[58px] w-full items-center gap-2 rounded-[10px] border border-[#E6E6E6] bg-white pl-3 pr-4 focus-within:border-brand-500">
          <span className="flex shrink-0 items-center gap-1.5">
            <svg
              viewBox="0 0 36 24"
              className="h-[18px] w-[27px] rounded-[3px]"
              role="img"
              aria-label="Türkiye"
            >
              ...
              <path
                d="m23.4 12 4.35-1.41-2.69 3.7v-4.58l2.69 3.7L23.4 12Z"
                fill="#fff"
              />
            </svg>
            <svg
              viewBox="0 0 10 6"
              className="h-1.5 w-2.5 fill-[#6B7885]"
              aria-hidden="true"
            >
        ...
        {sent && (
          <p
            role="status"
            className="text-center text-[14px] text-brand-700"
          >
